...
namespace MDS.Infrastructure.Settings
{
    ...
    public class AppSettings : IAppSettings
    {
        ...
        public string WsPostgres => ReadString("UriWsPostgres");
        public string EstadoWsPostgres => ReadString("EstadoWsPostgres");

        //KeySecret GoogleAutenticator
        public string KeySecretGoAuth => ReadString("KeySecretGoAuth");

        //KeyPasswordGenerator
        public string KeyGenerator => ReadString("KeyGenerator");
